...
public class LoginSteps {
    ...
    public void enterInvalidWithoutAndClickContinueButton(String email) throws IOException {
    ...
    public void enterInvalidAndClickSingInButton(String password) throws IOException {
